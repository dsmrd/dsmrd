...
$(document).ready(function() {
		setInterval(function() {
			...
			$.getJSON('api/devices/1/delivered', function(result){
				$('#devices_1_delivered').html(result);
				}).fail(function() {
